...
public class EquipmentManagementGUI extends BaseGUI implements ActionListener {
    ...
    private final 	String[] columnNames = {
    		"ID", "Name", "Description", "Price", "Date Added", "Availability", "Condition"
    		};
    ...
    private void loadEquipmentData() {
        equipmentList = client.getEquipments();
    }
    ...
    protected void initComponents() {
        ...
        Object[][] data = new Object[equipmentList.size()][7];
        for (int i = 0; i < equipmentList.size(); i++) {
            ...
            data[i][4] = equipment.getDate_added();
            data[i][5] = equipment.getAvailabilityStatus();
            data[i][6] = equipment.getConditionStatus();
        }
    ...
    private void deleteEquipment(int equipmentId) {
        ...
        if (toDelete != null && index >= 0) {
        	...
        	client.deleteEquipment(toDelete.getEquipmentId());
            // Remove from list
    ...
    private void showEquipmentDialog(Equipment equipment) {
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        panel.add(new JLabel("Date:  ex.(day/month/year): "), gbc);
        gbc.gridx = 1;
        gbc.anchor = GridBagConstraints.WEST;
        JTextField dateField = new JTextField(20);
        if (!isNewEquipment) {
        	dateField.setText(equipment.getDate_added().toString());
        }
        ...
        if (!isNewEquipment) {
        	priceField.setText(String.format("%.2f", equipment.getRentalPrice()));
        }
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (isNewEquipment) {
                    ...
                    Date date = new Date();
                    date.toDate(dateField.getText().trim());
                    ...
                    client.insertEquipment(newEquipment);
                    ...
                    if (existingEquipment != null) {
                        ...
                        client.updateEquipment(existingEquipment);
                        // Update table
