...
INSERT INTO `user` (`user_id`, `firstname`,`lastname`, `phone`, `email`,`username`, `user_password`) VALUES
(1, 'John Doe', '123-456-7890', 'johndoe@example.com','JDoe', 'password123'),
(2, 'Jane Smith', '234-567-8901', 'janesmith@example.com','JSmith', 'password123'),
(3, 'Robert Brown', '345-678-9012', 'robertbrown@example.com','RBrown', 'password123'),
(4, 'Emily Davis', '456-789-0123', 'emilydavis@example.com','EDavis', 'password123'),
(5, 'Michael Johnson', '567-890-1234', 'michaeljohnson@example.com','MJohnson', 'password123');
...
--     date_added VARCHAR(10), -- Storing date as VARCHAR in "MM/DD/YYYY" format
--     availabilityStatus VARCHAR(50),
--     conditionStatus VARCHAR(50)
-- );


INSERT INTO equipment (equipmentId, name, description, rentalPrice, date_added, availabilityStatus, conditionStatus) VALUES
(1, 'Generator', 'Portable power generator for various applications.', 75.50, '08/15/2023', 'Available', 'Excellent'),
(2, 'Water Pump', 'High-efficiency water pump for irrigation and drainage.', 45.00, '03/20/2024', 'Rented', 'Good'),
(3, 'Jackhammer', 'Heavy-duty jackhammer for demolition work.', 99.99, '11/01/2022', 'Available', 'Fair'),
(4, 'Concrete Mixer', 'Robust concrete mixer for small to medium projects.', 60.25, '05/10/2023', 'Under Maintenance', 'Needs Repair'),
(5, 'Scaffolding Set', 'Complete scaffolding set for construction and maintenance.', 120.00, '09/28/2024', 'Available', 'Good'),
(6, 'Welding Machine', 'Industrial welding machine for metal fabrication.', 85.75, '01/12/2025', 'Rented', 'Excellent'),
(7, 'Compressor', 'Powerful air compressor for pneumatic tools.', 55.00, '06/05/2023', 'Available', 'Good'),
(8, 'Power Washer', 'High-pressure power washer for cleaning surfaces.', 35.99, '04/01/2024', 'Available', 'Excellent'),
(9, 'Tile Cutter', 'Precision tile cutter for flooring and wall installations.', 25.50, '12/18/2022', 'Rented', 'Fair'),
(10, 'Lawn Mower', 'Gas-powered lawn mower for garden maintenance.', 40.00, '07/22/2023', 'Available', 'Good');
